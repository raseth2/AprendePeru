...
public class configuracion1 extends AppCompatActivity {
...
private void regsitro(){
   ...
   // txtopcion.setText("");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_conf1);
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // startActivity(new Intent(getApplicationContext(),configuracion2.class));
            }
        });
